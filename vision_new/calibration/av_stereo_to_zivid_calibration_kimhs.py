...
CALIB_MATS_DIR_AV_LEFT = "left_calibration_matrices_10_5_2023"
CALIB_MATS_PATH_AV_LEFT = os.path.join(cst.DATA_PATH, CALIB_MATS_DIR_AV_LEFT)
CALIB_MATS_DIR_AV_RIGHT = "right_calibration_matrices_10_5_2023"
...
CAPTURE_IMGS = True
N_IMGAGES = 9
IMG_SAVE_DIR = "aruco_imgs_capture_rect_10_5_2023"
...
TF_SAVE_PATH = os.path.join(cst.DATA_PATH, "aruco_calib_results_rect_10_5_2023")

TAG_SIZE = 0.075  # 0.0705  edge size in m
...
def main():
    ...
    #     av = Camera(cst.ALLIED_VISION_SINGLE, rectify_img=True)
    ...
    for counter in range(N_IMGAGES):
        img_left_av = cv2.imread(os.path.join(IMG_SAVE_PATH, f"{AV_LEFT_IMG_FNAME}{counter:02d}{cst.IMG_EXTENSION}"))
        img_right_av = cv2.imread(os.path.join(IMG_SAVE_PATH, f"{AV_RIGHT_IMG_FNAME}{counter:02d}{cst.IMG_EXTENSION}"))
        img_zivid = cv2.imread(os.path.join(IMG_SAVE_PATH, f"{ZIVID_IMG_FNAME}{counter:02d}{cst.IMG_EXTENSION}"))
        img_left_av_all.append(img_left_av)
        img_right_av_all.append(img_right_av)
        img_zivid_all.append(img_zivid)
