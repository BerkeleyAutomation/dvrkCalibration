...
class BlockDetection():
    def __init__(self):
        ...
        self.__sample_grasping_points = self.load_grasping_point(gp_number=3, dist_center=27, dist_gp=6)
        self.__sample_placing_points = self.load_grasping_point(gp_number=3, dist_center=27, dist_gp=6)
