...
def set_suturing_pipeline_input(psm_number):
    ...
    # Insertion poses
    pose_lists.append(
        (np.array([0.1088187, 0.08370875, -0.09635209]), np.array([0.50746778, 0.49848271, -0.49660786, 0.49736514]))
    )
    pose_lists.append(
        (np.array([0.13533885, 0.08416236, -0.09621308]), np.array([0.5720614, 0.41562694, -0.41562694, 0.5720614]))
    )
    pose_lists.append(
        (np.array([0.12961172, 0.08416236, -0.09685837]), np.array([0.61499985, 0.34896301, -0.34896301, 0.61499985]))
    )
    pose_lists.append(
        (np.array([0.12417177, 0.08416236, -0.09876189]), np.array([0.65020432, 0.27791067, -0.27791067, 0.65020432]))
    )
    pose_lists.append(
        (np.array([0.11929178, 0.08416236, -0.10182819]), np.array([0.6772321, 0.20336343, -0.20336343, 0.6772321]))
    )
    pose_lists.append(
        (np.array([0.11521647, 0.08416236, -0.10590351]), np.array([0.69574328, 0.12625879, -0.12625879, 0.69574328]))
    )
    pose_lists.append(
        (np.array([0.11215017, 0.08416236, -0.1107835]), np.array([0.7055051, 0.04756637, -0.04756637, 0.7055051]))
    )
    pose_lists.append(
        (np.array([0.11024665, 0.08416236, -0.11622345]), np.array([0.70639477, -0.03172423, 0.03172423, 0.70639477]))
    )
...
def extend_sutures(pose_lists, wound_start):
...
if __name__ == "__main__":
    ...
    pose_lists = extend_sutures(pose_lists, wound_start)
